...
export const Navbar = () => {
  ...
  return (
    <NextUINavbar maxWidth="xl" position="sticky" className="border-0">
      ...
      <NavbarContent className="hidden sm:flex basis-1/5 sm:basis-full" justify="end">
        ...
        {/* <NavbarItem className="hidden md:flex">
          <Button isExternal as={Link} className="text-sm font-normal text-default-600 bg-default-100" href={siteConfig.links.sponsor} startIcon={<HeartFilledIcon className="text-danger" />} variant="flat">
            Sponsor
          </Button>
        </NavbarItem> */}
      </NavbarContent>
